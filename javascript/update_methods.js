...
module.exports = {
    ...
    updateOrder: async function(res, order_id, username, beverage, size, restaurant, library, floor, segment, cost){
        response = await db.updateOrder(order_id, username, beverage, size, restaurant, library, floor, segment, cost);
        res.send(response);
        return;
    },
